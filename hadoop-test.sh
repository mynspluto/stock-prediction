...
# curl -i 'http://0.0.0.0:9870/webhdfs/v1/?op=LISTSTATUS'
# curl -i -X PUT 'http://0.0.0.0:9870/webhdfs/v1/airflow/test_data?op=MKDIRS'
# curl -i -X PUT -T test_file.txt 'http://0.0.0.0:9864/webhdfs/v1/airflow/test_data/test_file.txt?op=CREATE&namenoderpcaddress=0.0.0.0:8020&createflag=&createparent=true&overwrite=true'
# curl -i -X GET 'http://0.0.0.0:9864/webhdfs/v1/airflow/test_data/test_file.txt?op=OPEN&namenoderpcaddress=0.0.0.0:8020&offset=0'
